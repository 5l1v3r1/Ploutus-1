...
{
if(confirm('Are you sure you want to Update the Details? ')==false) return false;
var UserDbl=document.getElementById("list21");
for (var i=0;i<UserDbl.options.length;i++) 
{
UserDbl.options[i].selected = true;
