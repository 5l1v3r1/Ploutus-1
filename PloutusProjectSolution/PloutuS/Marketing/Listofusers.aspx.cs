...
public partial class Marketing_Listofusers : System.Web.UI.Page
{
    ...
    public void load()
    {
        try
        {
            if (Session["PSMEID"].ToString() != "" && Session["PSMEName"].ToString() != "")
            {
                ...
                #region //Accept,Reject Buttons Enabling
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        try
        {
         ...
         // string CertifiedIn=string.Empty;
          //if (chkCSS.Checked)
          //{
          //  CertifiedIn = "CSS";
          //}
          //else if(chkCPS.Checked)
          //{
          //     CertifiedIn = "CPS";
          //}
          //if (chkCPS.Checked && chkCSS.Checked)
          //{
    ...
    public void BindRepeater(DataSet ds)
    {
...
"<br/>" +
  ...
  "  </td></tr>" +
   ...
   " </table></div></body></html>");
    ...
    //{
    //    string Jsid = ency.EncryptDecryptString("£", ViewState["jsid"].ToString());
    //    Response.Redirect("Listofusers.aspx?id="+Jsid+"&flagV=1");
    //}
