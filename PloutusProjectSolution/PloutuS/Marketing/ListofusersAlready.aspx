<%@ Page Title="" Language="C#" MasterPageFile="~/Marketing/InnerMasterEmp.master"
    AutoEventWireup="true" CodeFile="ListofusersAlready.aspx.cs" Inherits="Marketing_Listofusers" %>
                                                                ...
                                                                <tr>
                                                                 ...
                                                                 <tr>
                                                                     <td> <div>
                                                                                ...
                                                                                <div style="float: left; ">
                                                                                    <asp:Label ID="Label6" Text='<%# Eval("phone")%>' runat="server"></asp:Label>
                                                                                </div>
                                                                            </div></td>
                                                        ...
                                                        <tr>
                                                            <td style="padding-left: 10px" align="left">
                                                                <asp:UpdatePanel ID="updownload" runat="server">
                                                                    <ContentTemplate>
                                                                        <asp:LinkButton ID="lnkbtnDResume" runat="server" OnClick="lnkbtnDResume_Click">Download Resume</asp:LinkButton></ContentTemplate>
                                                                    <Triggers>
                ...
                <div id="Div2" style="display: none">
                    <asp:Panel ID="Panel1" runat="server" BackColor="#E6E6EF">
                        <table style="height: 450px; width: 600px;">
                            ...
                            <tr>
                                <td>
                                <asp:TextBox ID="txtViewResume" TextMode="MultiLine" Width="700px" Height="480px" runat="server"></asp:TextBox>
