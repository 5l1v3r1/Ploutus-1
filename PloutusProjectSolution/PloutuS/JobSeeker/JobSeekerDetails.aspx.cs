...
public partial class JS_JobDetails : System.Web.UI.Page
{
    ...
    {
        BA_jobseekercatandloc jobseekercatloc = new BA_jobseekercatandloc();
        DataSet ds = new DataSet();
        ds = jobseekercatloc.GetJssearchJobs(ViewState["FunAreaLoc"].ToString(), ViewState["Type"].ToString(), ViewState["orderby"].ToString(), Session["maincatJ"].ToString(), Session["maintypeJ"].ToString());
        if (ds != null)
        {
