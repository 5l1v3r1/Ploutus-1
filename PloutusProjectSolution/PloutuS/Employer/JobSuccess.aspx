<%@ Page Language="C#" AutoEventWireup="true" CodeFile="JobSuccess.aspx.cs" MasterPageFile="~/Employer/MerchantMaster.master" Inherits="Employer_JobSuccess" %>
            ...
            <td align="center">
                <table cellpadding="0" cellspacing="0" style="width: 80%;">
                    ...
                    <tr align="center" style="height: 80px">
                        ...
                        Successfully Posted the Job.<br /><a href="EmployerHomePage.aspx">Click here</a> to go Home Page
                        </asp:Label>
                        </td>
                    </tr>
                </table>
