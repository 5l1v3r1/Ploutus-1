<%@ Page Title="" Language="C#" MasterPageFile="~/NewMain.master" AutoEventWireup="true"
    CodeFile="JobSeekerRegistration.aspx.cs" Inherits="_Default" %>
    ...
    <table cellpadding="0" cellspacing="0" class="tbl" width="100%">
        <tr>
            <td colspan="5" align="center" style="padding-top: 20px; padding-bottom: 10px;" class="headding1">
                <asp:Label ID="Label19" runat="server" Text="Job Seekers Registration"></asp:Label>
            </td>
        </tr>
        <tr>
                        ...
                        <td>
                            <table class="tbl" style="width: 900px;" border="0" cellpadding="1px" cellspacing="0">
                                ...
                                <tr>
                                    ...
                                    <td colspan="3">
                                        <asp:TextBox ID="txtAddr2" runat="server" CssClass="txtbox-lrg1" MaxLength="50"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td colspan="3">
                                        ...
                                        <span class="errmsg">&nbsp;*</span> <span class="bodytext">&nbsp;&nbsp;xxxxx</span>
                                        <asp:RegularExpressionValidator ID="RegZip" runat="server" ControlToValidate="txtZip"
                                            SetFocusOnError="true" Display="None" ErrorMessage="Zipcode must be 5 numerics only."
                                        ...
                                        <asp:RequiredFieldValidator ID="rfvZip" runat="server" ControlToValidate="txtZip"
                                            CssClass="errmsg" SetFocusOnError="true" Display="None" ErrorMessage="Please enter zipcode"></asp:RequiredFieldValidator>
                                        <cc1:ValidatorCalloutExtender ID="vceZip" runat="server" TargetControlID="rfvZip">
                                        </cc1:ValidatorCalloutExtender>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td colspan="3">
                                        <asp:TextBox ID="txtPhone" CssClass="txtbox-lrg1" runat="server" MaxLength="13"></asp:TextBox>
                                        <asp:Label ID="Label30" runat="server" Text="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(xxx)xxx-xxxx"
                                        ...
                                        <asp:RegularExpressionValidator ID="RegPhone" runat="server" ControlToValidate="txtPhone"
                                            ...
                                            ValidationExpression="((\(\d{3}\) ?)|(\d{3}-))?\d{3}-\d{4}" CssClass="errmsg"></asp:RegularExpressionValidator>
                                        ...
                                        <%--<cc1:MaskedEditExtender ID="MaskedEditExtender1" runat="server" TargetControlID="txtPhone"
                                            MaskType="None" Mask="(999)999-9999" MessageValidatorTip="false" InputDirection="LeftToRight"
                                            ErrorTooltipEnabled="True">
                                        </cc1:MaskedEditExtender>--%>
                                        <%--<cc1:MaskedEditValidator ID="MaskedEditValidator1" runat="server" ControlToValidate="txtPhone"
                                            ControlExtender="MaskedEditExtender1" Display="None" SetFocusOnError="true" IsValidEmpty="false"
                                            ValidationExpression="\d{10}(-\d{9})?"
                                            InvalidValueMessage="Invalid Phone Number!" CssClass="errmsg" ErrorMessage="Phone number Invalid">
                                        </cc1:MaskedEditValidator>
                                        <cc1:ValidatorCalloutExtender ID="vceMask" runat="server" TargetControlID="MaskedEditValidator1">
                                        </cc1:ValidatorCalloutExtender>--%>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td colspan="3">
                                        ...
                                        <%--<cc1:MaskedEditExtender ID="MaskedEditExtender2" AutoComplete="false" runat="server"
                                            TargetControlID="txtMobile" Mask="(999)999-9999" MaskType="Number">
                                        </cc1:MaskedEditExtender>--%>
                                        <asp:RegularExpressionValidator ID="revMobile" runat="server" CssClass="errmsg" ControlToValidate="txtMobile"
                                        ...
                                        <cc1:ValidatorCalloutExtender ID="vceMobile" runat="server" TargetControlID="revMobile">
                                        </cc1:ValidatorCalloutExtender>
                                        <%--<cc1:MaskedEditValidator ID="maskedit" runat="server" ControlExtender="MaskedEditExtender2"
                                            IsValidEmpty="false" InvalidValueMessage="Invalid Mobile Number!" SetFocusOnError="true" ControlToValidate="txtMobile" ValidationExpression="\d{10}(-\d{9})?"
                                            CssClass="errmsg" ErrorMessage="Mobile number Invalid"></cc1:MaskedEditValidator>--%>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td colspan="3">
                                        <asp:TextBox ID="txtEmail" CssClass="txtbox-lrg1" runat="server" MaxLength="150"></asp:TextBox>
                                        <span class="errmsg">&nbsp;*</span>
                        ...
                        <td>
                            <table class="tbl" style="width: 900px;" border="0" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtMRecentEmployer" runat="server" CssClass="txtbox-lrg1" MaxLength="50"></asp:TextBox>
                                        <%-- <span class="errmsg">&nbsp;*</span>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtJobTitle" runat="server" CssClass="txtbox-lrg1" MaxLength="50"></asp:TextBox>
                                        <span class="errmsg">&nbsp;*</span>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <asp:RequiredFieldValidator ID="rqvHighestEdu" runat="server" ControlToValidate="ddlHEdu"
                                            Display="None" ErrorMessage="Select your Heighest Education" InitialValue="-1"
                        ...
                        <td>
                            <table class="tbl" style="width: 900px;" border="0" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtPassword" runat="server" CssClass="txtbox-lrg1" TextMode="Password"
                                            MaxLength="16"></asp:TextBox>
                                        <span class="errmsg">&nbsp;*</span>
                                        <asp:RequiredFieldValidator ID="ReqPassword" runat="server" ControlToValidate="txtPassword"
                                            Display="None" ErrorMessage="Please enter the password" SetFocusOnError="true"
                                            CssClass="errmsg"></asp:RequiredFieldValidator>
                                        <cc1:ValidatorCalloutExtender ID="vcPassword" runat="server" TargetControlID="ReqPassword">
                                        </cc1:ValidatorCalloutExtender>
                                        <asp:RegularExpressionValidator ID="regPassword" runat="server" ControlToValidate="txtPassword"
                                            Display="None" ErrorMessage="Password should follow below mentioned format"
                                            SetFocusOnError="true" ValidationExpression="^.*(?=.{8,16})(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9]).*$"
                                        ...
                                        <cc1:PasswordStrength ID="PS" runat="server" TargetControlID="txtPassword" DisplayPosition="RightSide"
                                            StrengthIndicatorType="Text" PreferredPasswordLength="8" PrefixText=""
                                            HelpStatusLabelID="lblhelp" MinimumNumericCharacters="1" MinimumSymbolCharacters="1"
                                            MinimumLowerCaseCharacters="1" MinimumUpperCaseCharacters="1" RequiresUpperAndLowerCaseCharacters="true"
                                            TextStrengthDescriptions="Weak;Average;Strong" TextStrengthDescriptionStyles="ajaxpasscss;ajaxpasscss1;ajaxpasscss2" />
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <asp:Label ID="lblhelp" runat="server" CssClass="errmsg" />
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtRPassword" runat="server" CssClass="txtbox-lrg1" TextMode="Password"
                                            MaxLength="16"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="rqvtxtRPassword" runat="server" SetFocusOnError="true"
                                            Display="None" ErrorMessage="Please retype the password" CssClass="errmsg" ControlToValidate="txtRPassword"></asp:RequiredFieldValidator>
                                        <cc1:ValidatorCalloutExtender ID="vcetxtRPassword" runat="server" TargetControlID="rqvtxtRPassword">
                                        </cc1:ValidatorCalloutExtender>
                                        <asp:CompareValidator ID="ComparePassword" runat="server" ControlToCompare="txtPassword"
                                            ControlToValidate="txtRPassword" CssClass="errmsg" Display="None" ErrorMessage="Passwords dosen't match"
                                            SetFocusOnError="true"></asp:CompareValidator>
                                        <cc1:ValidatorCalloutExtender ID="vcRPassword" runat="server" TargetControlID="ComparePassword">
                                        </cc1:ValidatorCalloutExtender>
                                    </td>
                                </tr>
                                <tr>
                    ...
                    <tr>
                        <td>
                            <table class="tbl" style="width: 900px;" border="0" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    <td style="width: 225px;">
                                        &nbsp;<asp:Label ID="Label24" runat="server" Text="Upload Your Resume" ></asp:Label>
                                    </td>
                                    <td>
                                        <asp:FileUpload ID="fpResume" runat="server" />
                                        <span class="errmsg">&nbsp;*</span>
                                        <asp:RequiredFieldValidator ID="rfvFile" runat="server" ControlToValidate="fpResume"
                                ...
                                <tr>
                                    <td colspan="2">
                                        <p>
                                            &nbsp;Upload Resume (Supported file type - .DOC, .DOCX)
                                        </p>
                                        <%-- <p>
                                            &nbsp;You can either upload a resumeor edit a resume on Thingamajob.com.
                                        </p>--%>
                                        <p>
                                            &nbsp;The site only keeps the most current version of your resume.</p>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2">
