<%@ Page Title="" Language="C#" MasterPageFile="~/JobSeeker/InnerMaster.master" AutoEventWireup="true" CodeFile="Acknowledgment_jobseeker.aspx.cs" Inherits="Acknowledgment_jobseeker" %>
...
BY SIGNING BELOW I ACKNOWLEDGE THAT I HAVE READ, UNDERSTOOD AND AGREE TO THE ABOVE STATEMENTS
                    ...
                    <tr>
                        ...
                        <td colspan="2">
                            <asp:CheckBox ID="chk1" Text=" " runat="server" OnCheckedChanged="chk1_CheckedChanged"/>
        ...
        <tr>
            <td colspan="4" align="right" style="padding-right: 25px">
                <asp:Button ID="btnFinish" runat="server" Text="Finish" CssClass="btn" OnClick="btnFinish_Click" />
