...
public partial class Employer_AcceptedApplicants : System.Web.UI.Page
{
    ...
    {
        BA_ScheduleJobs baschedule = new BA_ScheduleJobs();
        DataSet ds = new DataSet();

        ds = baschedule.getScheduleCandidates( Session["PSEName"].ToString());
