<%@ Page Title="" Language="C#" MasterPageFile="~/JobSeeker/InnerMaster.master" AutoEventWireup="true"
    CodeFile="JobSeekerdescUser.aspx.cs" Inherits="JobdescUser" %>
                                                    ...
                                                    <table style="width: 100%">
                                                        <tr>
                                                            <td style="padding-left: 20px;" align="left">                                                              
                                                                ...
                                                                <asp:Button ID="btnBackForApplied" runat="server" Text="Back" CssClass="btn" OnClientClick="history.go(-1)" OnClick="btnbackApplied_Click" />
                                                            </td>
                                                            <td align="center">
                                            ...
                                            <asp:DataList ID="dlJobPosting" runat="server" Style="text-align: left; width: 100%">
                                                ...
                                                <ItemTemplate>
                                                    <table cellpadding="3" cellspacing="3" border="0" style="width: 100%">
                                                        <tr>
                                                        <td class="org-shearder-bgNew" colspan="3"> <%# Eval("JobTitle")%>
