<%@ Page Title="" Language="C#" MasterPageFile="~/NewMain.master" AutoEventWireup="true" CodeFile="Employment_Jobseeker.aspx.cs" Inherits="Employment_Jobseeker" %>
                        ...
                        <td>
                            <table class="tbl" style="width: 900px;" border="0" cellpadding="1px" cellspacing="0">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtEmergencyName" CssClass="txtbox" runat="server" MaxLength="100"></asp:TextBox>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txt1" CssClass="txtbox" runat="server" MaxLength="100"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txt2" CssClass="txtbox" runat="server" MaxLength="100"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <asp:TextBox ID="TextBox5" CssClass="txtbox" runat="server" MaxLength="100"></asp:TextBox>
                                    </td>
                                </tr>
                        ...
                        <td>
                            <table class="tbl" style="width: 900px;" border="0" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="TextBox1" CssClass="txtbox" runat="server" MaxLength="100"></asp:TextBox>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="TextBox2" CssClass="txtbox" runat="server" MaxLength="100"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <asp:TextBox ID="TextBox3" CssClass="txtbox" runat="server" MaxLength="100"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <asp:TextBox ID="TextBox4" CssClass="txtbox" runat="server" MaxLength="100"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <asp:TextBox ID="TextBox6" CssClass="txtbox" runat="server" MaxLength="100"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <asp:TextBox ID="TextBox7" CssClass="txtbox" runat="server" MaxLength="100"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="TextBox9" CssClass="txtbox-lrg1" runat="server" MaxLength="100"></asp:TextBox>
                                    </td>
                                </tr>
                        ...
                        <td>
                            <table class="tbl" style="width: 900px;" border="0" cellpadding="1px" cellspacing="0">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="TextBox11" CssClass="txtbox" runat="server" MaxLength="100"></asp:TextBox>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="TextBox12" CssClass="txtbox" runat="server" MaxLength="100"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <asp:TextBox ID="TextBox13" CssClass="txtbox" runat="server" MaxLength="100"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <asp:TextBox ID="TextBox14" CssClass="txtbox" runat="server" MaxLength="100"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <asp:TextBox ID="TextBox15" CssClass="txtbox" runat="server" MaxLength="100"></asp:TextBox>
                                    </td>
                                </tr>
