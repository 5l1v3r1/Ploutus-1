<%@ Page Title="" Language="C#" MasterPageFile="~/JobSeeker/InnerMaster.master" AutoEventWireup="true"
    CodeFile="JobSeekerCategories.aspx.cs" Inherits="Js_JobCategories" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div style="min-height: 680px;">
        <table width="100%" cellpadding="0" cellspacing="0">
            ...
            <tr>
                <td align="center">
                    <table class="tbl" width="924px" cellpadding="0" cellspacing="0" border="0" style="border-color:#FFC498">
                        <tr>
                                        ...
                                        <table cellpadding="4" cellspacing="4" border="0">
                                            <tr>
                                                <td style="width: 308px;">
                                                    <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# Eval("EncFunArea", "JobSeekerDetails.aspx?id={0}&id1=1") %>'
            ...
            <tr>
                <td align="center">
                    <table class="tbl" width="620px" cellpadding="0" cellspacing="0" style="border-color:#FFC498" border="0">
                        <tr>
                            <td align="left" class="org-shearder-bgNew">
                                ...
                                <asp:DataList ID="dlJobsByState" runat="server" Font-Bold="False" Font-Italic="False"
                                    ...
                                    <ItemTemplate>
                                        <table cellpadding="4" cellspacing="4" border="0">
                                            <tr>
                                                <td style="width: 308px;">
                                                    <asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl='<%# Eval("encloc", "JobSeekerDetails.aspx?id={0}&id1=2") %>'
            ...
            <tr>
                <td align="center">
                    <table width="924px">
                        <tr>
                            <td align="right">
                                <asp:LinkButton ID="lnbtnBack" runat="server" OnClick="lnbtnBack_Click">Back</asp:LinkButton>
                            </td>
                        </tr>
                    </table>
                </td>
