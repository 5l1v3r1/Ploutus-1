<%@ Page Title="Accepted Profiles" Language="C#" MasterPageFile="~/Marketing/InnerMasterEmp.master"
    AutoEventWireup="true" CodeFile="AcceptedCanList.aspx.cs" Inherits="Marketing_AcceptedCanList" %>
        ...
        <tr>
            <td align="center">
                <asp:Panel ID="pnl" runat="server">
                    <table cellpadding="4" cellspacing="4" width="90%" class="MainSearchDiv1">
                        <tr>
                            <td align="left" class="SearchSubDiv1">
                                <table cellpadding="2" cellspacing="2" style="width:100%" >
                                    ...
                                    <tr>
                                        ...
                                        <td align="center">
                                            <asp:DropDownList ID="ddlexpfrom" runat="server" Width="70px" Height="22px">
                                        ...
                                        <td align="center">
                                            <asp:DropDownList ID="ddlexpto" runat="server" Width="70px" Height="22px">
                                        ...
                                        <td align="center">
                                            <asp:DropDownList ID="ddlstate" runat="server" Height="22px" Width="170">
                                            </asp:DropDownList>
                                        </td>
                                       <%-- <td align="center">
                                                        ...
                                                        <tr>
                                                            <td style="padding-left: 5px; padding-right: 5px;">
                                                                <table cellpadding="0" cellspacing="0" border="0" style="width: 100%; padding: s0px;">
                                                                    <tr>
                                                                        <td colspan="2" align="left" class="sgrid-headiing-black" width="20%">
                                                                            <asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl='<%# Eval("encryptid", "SelectedCandidatesProfile.aspx?id={0}") %>' CssClass="sgrid-headiing-Green"> <%# Eval("Name")%></asp:HyperLink>
                                                                              
                                                                            <%-- <%# Eval("Name")%>--%>
                                                                        </td>
                                                                        <td colspan="2" align="left" class="lable" width="25%">
                                                                            <%# Eval("industry")%>
                                                                        </td>
                                                                         <td align="left" class="lable" width="15%" >
                                                                            <%# Eval("state")%>
                                                                        </td>
                                                                         <td align="left" class="lable" width="15%" >
                                                                            <%# Eval("city")%>
