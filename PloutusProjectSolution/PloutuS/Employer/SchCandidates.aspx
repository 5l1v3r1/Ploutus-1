<%@ Page Title="" Language="C#" MasterPageFile="~/Employer/MerchantMaster.master"
    AutoEventWireup="true" CodeFile="SchCandidates.aspx.cs" Inherits="Employer_AcceptedApplicants" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:Panel ID="pnlMain" runat="server">
        <table table width="900px" style="border: 1px solid silver" align="center" cellpadding="0" cellspacing="0" >
            <tr>
            ...
            <tr>
                <td>
                    <asp:GridView ID="dljobdet" runat="server" AllowPaging="false" GridLines="None" CellPadding="4"
                        ...
                        <Columns>
                            <asp:BoundField DataField="candidate" HeaderText="Applicant Name"></asp:BoundField>
                            <asp:BoundField DataField="position" HeaderText="Applied Position"></asp:BoundField>
                            <asp:BoundField DataField="Exp" HeaderText="Experience"></asp:BoundField>
                            <asp:BoundField DataField="Skills" HeaderText="Skills"></asp:BoundField>
                            <asp:BoundField DataField="Selectdt" HeaderText="Selected Date"></asp:BoundField>
                            <asp:TemplateField HeaderText="">
                                <ItemTemplate>
                                    <asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl='<%# Eval("id", "ViewSelected.aspx?id={0}") %>'>View</asp:HyperLink>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
