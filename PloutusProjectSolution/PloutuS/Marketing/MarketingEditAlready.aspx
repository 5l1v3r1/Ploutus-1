<%@ Page Title="" Language="C#" MasterPageFile="~/Marketing/InnerMasterEmp.master"
    AutoEventWireup="true" CodeFile="MarketingEditAlready.aspx.cs" Inherits="Marketing_MarketingEdit" %>
                ...
                <table cellspacing="5" cellpadding="5" class="tbl" style="width: 900px;" border="0">
                    <tr>
                        ...
                        <td style="width: 240px;padding-left:10px">
                            <asp:TextBox ID="txtFName" CssClass="txtbox-lrg1" MaxLength="100" Width="230px" runat="server"></asp:TextBox>
                        </td>
                        <td>
                            <asp:TextBox ID="txtMName" CssClass="txtbox" MaxLength="1" runat="server" Width="30px"></asp:TextBox>
                        </td>
                        <td>
                            <asp:TextBox ID="txtLName" CssClass="txtbox-lrg1" MaxLength="100" Width="230px" runat="server"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td colspan="3" style="padding-left: 10px;">
                            <asp:TextBox ID="txtMobileNumber" MaxLength="15" runat="server" CssClass="txtbox-lrg1"></asp:TextBox>
                            <%--  <span class="errmsg">&nbsp;*</span>--%>
                            ...
                            <cc1:ValidatorCalloutExtender ID="VCCL1" runat="server" TargetControlID="regmobile">
                            </cc1:ValidatorCalloutExtender>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td colspan="3" style="padding-left: 10px;">
                            <asp:TextBox ID="txtCellNumber" MaxLength="15" runat="server" CssClass="txtbox-lrg1"></asp:TextBox>
                            ...
                            <asp:RegularExpressionValidator ID="revCellNumber" ControlToValidate="txtCellNumber"
                                runat="server" SetFocusOnError="true" Display="None" ValidationExpression="\(?\d{3}\)?-? *\d{3}-? *-?\d{4}"
                                ErrorMessage="Please Enter Valid PhoneNmber"></asp:RegularExpressionValidator>
                            <cc1:ValidatorCalloutExtender ID="VCCL" runat="server" TargetControlID="revCellNumber">
                            </cc1:ValidatorCalloutExtender>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td colspan="3" style="padding-left: 10px;">
                            <asp:TextBox ID="txtHomeNumber" MaxLength="15" runat="server" CssClass="txtbox-lrg1"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td colspan="3" style="padding-left: 10px;">
                            <asp:DropDownList ID="ddlYearsExp" runat="server" CssClass="ddlboxsm1">
                            ...
                            <asp:DropDownList ID="ddlMonthsExp" runat="server" CssClass="ddlboxsm1">
                                <asp:ListItem Value="-1">Select</asp:ListItem>
                                <asp:ListItem Value="0">0</asp:ListItem>
                                <asp:ListItem Value="1">1</asp:ListItem>
                                <asp:ListItem Value="2">2</asp:ListItem>
                    ...
                    <tr>
                        <td>
                            &nbsp;<asp:Label ID="Label5" runat="server" Text="State" CssClass="lbl"></asp:Label>
                        </td>
                        <td colspan="3" style="padding-left: 10px;" style="padding-left: 10px;">
                            <asp:DropDownList ID="ddlState" CssClass="ddlboxlrg" runat="server" AutoPostBack="true"
                                OnSelectedIndexChanged="ddlState_SelectedIndexChanged">
                            </asp:DropDownList>
                            <span class="errmsg">*</span>
                            <asp:RequiredFieldValidator ID="ReqState" runat="server" ControlToValidate="ddlState"
                                InitialValue="Select" SetFocusOnError="true" Display="None" ErrorMessage="Please Select State"
                                CssClass="errmsg"></asp:RequiredFieldValidator>
                    ...
                    <tr>
                        <td>
                            &nbsp;<asp:Label ID="Label4" runat="server" Text="City" CssClass="lbl"></asp:Label>
                        </td>
                        <td colspan="3" style="padding-left: 10px;">
                            <asp:DropDownList ID="ddlcity" CssClass="ddlboxlrg" runat="server">
                            </asp:DropDownList>
                            <span class="errmsg">&nbsp;*</span>
                            <asp:RequiredFieldValidator ID="RequiredCity" InitialValue="Select" runat="server"
                                ControlToValidate="ddlcity" SetFocusOnError="true" Display="None" ErrorMessage="Please Select City"
                                CssClass="errmsg"></asp:RequiredFieldValidator>
                    ...
                    <tr>
                        ...
                        <td colspan="3" style="padding-left: 10px;">
                            <asp:TextBox ID="txtAddress" TextMode="MultiLine" Rows="10" Columns="40" runat="server"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td>
