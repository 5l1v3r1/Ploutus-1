...
public partial class Marketing_AcceptedCanList : System.Web.UI.Page
{
    ...
    protected void btnsearch_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            {
                System.Web.UI.ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "AlertBox", "alert('Please Enter Name Or Exp Or Industry or State');", true);
            }
            else
            {
                ...
                ds = mar.SearchAcceptcanList(name, expfrom, expto, industry,state, city);
