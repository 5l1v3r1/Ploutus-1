<%@ Page Title="" Language="C#" MasterPageFile="~/Employer/MerchantMaster.master" AutoEventWireup="true" CodeFile="ViewPremanentEmployee.aspx.cs" Inherits="Employer_ViewPremanentEmployee" %>
        ...
        <table cellpadding="0" cellspacing="0" border="0" width="100%" style="min-height: 670px;
            ...
            <tr>
                <td align="center" class="headding1" style="padding-top: 50px; padding-bottom: 30px;">
                    <asp:Label ID="Label19" runat="server" Text="Premanent Employee"></asp:Label>
                </td>
            </tr>
            <tr>
                <td align="left">
                            ...
                            <table cellpadding="0" cellspacing="0" style="width: 924px;">
                                    ...
                                    <td>
                                        <table class="tbl" cellpadding="0" cellspacing="0" style="width: 924px;">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <%# Eval("JobType")%>--<%# Eval("StartDate")%></td>
                                            </tr>
                                            <tr>
                                                <td style="width: 200px;">
                                ...
                                <tr>
                                    <td align="right" style="padding-top: 50px; padding-bottom: 50px">
                                        <asp:LinkButton ID="LinkButton2" CssClass="stylink" runat="server" PostBackUrl="~/Employer/PremanentEmployes.aspx">Back</asp:LinkButton>
                                    </td>
                                </tr>
                            </table>
                        </ItemTemplate>
