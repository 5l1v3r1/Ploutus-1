<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HoldCandidates.aspx.cs" MasterPageFile="~/Marketing/InnerMasterEmp.master" Inherits="Marketing_HoldCandidates" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <table cellpadding="0" cellspacing="0" style="width: 100%;">
        ...
        <tr align="center" style="height: 20px;">
            <td style="width: 100%;" colspan="3">
                <asp:Label ID="Label8" runat="server" CssClass="headding" Text="Search Holding Candidates"></asp:Label>
            </td>
        </tr>
        <tr>
            <td align="center">
