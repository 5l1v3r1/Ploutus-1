<%@ Page Title="Profile" Language="C#" MasterPageFile="~/Marketing/InnerMasterEmp.master" AutoEventWireup="true" ValidateRequest="false" CodeFile="Listofusers3.aspx.cs" Inherits="Marketing_Listofusers" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" EnableViewState="false" runat="Server">
    ...
    <%-- <script type="text/javascript">
         ...
         //Working fine this AJAX method Call
         $(function () {
             $('.editSavebtn').click(function (e) {
                 e.preventDefault();
                 var jsid = document.getElementById("<%=hdf_Jsid.ClientID%>").value;
                 alert(jsid);
                 var url = "DownLoadFilesHandler.ashx?fpath=" + jsid;
...
//              clickButton.click();
    ...
    <table cellpadding="0" cellspacing="0" border="0" width="100%">      
                                                                        ...
                                                                        <table width="100%" border="0" align="left" class="tbl" style="border:1px solid #FEF7E5;border-bottom: 1px solid #FFC498;
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td width="60%" style=" float:right;" class="mLinks" bgcolor="#FEF7E5">
                                                                                    <asp:LinkButton ID="btnedit" runat="server" OnClick="editdetails" CssClass="btn" CausesValidation="false"
                                                                                        Text="Edit" />
                                                                                </td>
                                                                            </tr>
                                                                        </table>
       ...
       <asp:TextBox ID="txtAddress" TextMode="MultiLine" Height="60px"  MaxLength="80" runat="server" Text='<%# Eval("Address") %>'
            ...
            <asp:Button ID="btnSave" runat="server" Text="Update" CssClass="editSavebtn" Width="99px" CausesValidation="false" OnClick="btnSave_Click"/>                                                    
                                                &nbsp;
  <asp:Button ID="Button2" runat="server" Text="Cancel" CausesValidation="false" CssClass="btn" Width="99px" OnClientClick="return MPeditClose();" />
                ...
                <asp:ModalPopupExtender ID="mpedit" runat="server" TargetControlID="hdn1" PopupControlID="x1" 
                    BackgroundCssClass="Inactive"  CancelControlID="Button2" DropShadow="true">
                </asp:ModalPopupExtender>            
