<%@ Page Title="" Language="C#" MasterPageFile="Site.master" AutoEventWireup="true"
    CodeFile="JobdescUser.aspx.cs" Inherits="JobdescUser" %>
...
<div style="min-height:680px;">
    ...
    <%--<table cellpadding="0" cellspacing="0" border="0" style="height: 630px; width: 100%;">
        <tr>
            <td align="center" style="padding-top: 20px; padding-bottom: 30px;" class="headding1">
                <asp:Label ID="lblhead" runat="server" Text="Job Description"></asp:Label>
            </td>
        ...
        <tr>
            <td align="center">
                ...
                <asp:Panel ID="pnl1" Width="80%" runat="server">
                    <table cellpadding="0" cellspacing="0" border="0" style="width: 95%; background-color: white;">
                        <tr>
                            <td style="height: 20px; border-width: 0px;">
                            </td>
                        </tr>
                        <tr>
                            <td align="center" style="border: 0px;">
                                <table cellpadding="0" cellspacing="0" style="width: 100%">
                                                ...
                                                <ContentTemplate>
                                                    <table style="width: 100%">
                                                        <tr>
                                                            <td style="padding-left: 20px;" align="left">                                                              
                                                                <asp:Button ID="btnback" runat="server" Text="Back" CssClass="btn" OnClick="btnback_Click" />
                                                                <asp:Button ID="btnBackForApplied" runat="server" Text="Back" CssClass="btn" OnClick="btnbackApplied_Click" />
                                                            </td>
                                                            <td align="center">
                                                                <asp:Label ID="lblmsg" runat="server" Text="Label" CssClass="errmsg" Visible="False"></asp:Label>
                                                            </td>
                                    ...
                                    <tr>
                                        <td valign="top">
                                            <asp:DataList ID="tbljobdet" runat="server" Style="text-align: left; width: 100%">
                                                <HeaderTemplate>
                                                    <table cellpadding="2" cellspacing="0" border="0" style="width: 100%">
                                                    </table>
                                                </HeaderTemplate>
                                                    ...
                                                    <table cellpadding="3" cellspacing="3" border="0" style="width: 100%">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                ...
                                                                <tr>
                                                                    <td style="font-size: 13px; font-weight: 700;" colspan="2">
                                                                        Are you looking for a challenging job opportunity in the IT industry? Do you have
                                                                        years of experience in IT and want to GROW your career….then we have the job for
                                                                        you!
                                                                    </td>
                                                                </tr>
                                                                <tr>
