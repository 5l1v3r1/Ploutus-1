<%@ Page Title="Job Posting" Language="C#" MasterPageFile="~/Marketing/InnerMasterEmp.master"
    AutoEventWireup="true" EnableEventValidation="true" CodeFile="PostJob.aspx.cs"
    Inherits="Employer_PostJob" %>
                                     ...
                                     <%--   <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <cc1:ValidatorCalloutExtender ID="vceJobTitle" runat="server" TargetControlID="rfvJobTitle">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <cc1:ValidatorCalloutExtender ID="ValidatorCalloutExtender6" runat="server" TargetControlID="rfvDesc">
                                                </cc1:ValidatorCalloutExtender>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <asp:RequiredFieldValidator ID="rfvIndustry" runat="server" ErrorMessage="Please select Industry"
                                                    ...
                                                    ValidationGroup="Job"></asp:RequiredFieldValidator>
                                                <cc1:ValidatorCalloutExtender ID="ValidatorCalloutExtender1" runat="server" TargetControlID="rfvIndustry">
                                                </cc1:ValidatorCalloutExtender>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td style="height: 32px">
                                                <asp:RequiredFieldValidator ID="rfvmax" runat="server" ErrorMessage="Please Select Max Salary"
                                                    ...
                                                    ValidationGroup="Job"></asp:RequiredFieldValidator>
                                                <cc1:ValidatorCalloutExtender ID="vcemax" runat="server" TargetControlID="rfvmax">
                                                </cc1:ValidatorCalloutExtender>
                                                <asp:RequiredFieldValidator ID="rfvmin" runat="server" ErrorMessage="Please Select Min Salary"
                                                    ...
                                                    ValidationGroup="Job"></asp:RequiredFieldValidator>
                                                <cc1:ValidatorCalloutExtender ID="vcemin" runat="server" TargetControlID="rfvmin">
                                                </cc1:ValidatorCalloutExtender>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                             <asp:TextBox ID="txtRate" runat="server" CssClass="txtbox-lrg11" MaxLength="11"></asp:TextBox>
                                            </td>
                                            <%--<td>
                    ...
                    <td align="center" style="padding-left: 50px; padding-right: 50px; padding-top:0px;">
                        ...
                        <table cellspacing="5" cellpadding="5">
                            ...
                            <td width="133px">
                                ...
                                <td align="left" >
                                    <asp:Button ID="btPost" Text="Submit" runat="server" CssClass="btn" OnClick="btPost_Click"
                                        ValidationGroup="Job" />
                                    &nbsp;
