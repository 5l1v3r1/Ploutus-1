<%@ Page Title="" Language="C#" MasterPageFile="~/Employer/MerchantMaster.master" AutoEventWireup="true" CodeFile="ContractEmployes.aspx.cs" Inherits="Employer_ContractEmployee" %>
                    ...
                    <asp:GridView ID="dljobdet" runat="server" AllowPaging="false" GridLines="None" CellPadding="4"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="">
                                <ItemTemplate>
                                    <asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl='<%# Eval("id", "ViewContractEmployee.aspx?id={0}") %>'>View</asp:HyperLink>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
