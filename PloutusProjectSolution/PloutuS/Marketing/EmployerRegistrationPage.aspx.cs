...
public partial class EmployerRegistrationPage : System.Web.UI.Page
{
   ...
   protected void btnSubmit_Click1(object sender, EventArgs e)
    ...
    {
        Response.Redirect("MarketingHomePage.aspx");
    }
    protected void SendMail()
    {
        ...
        string Message = "<P align='left'>Dear " + txtContact.Text + " </P>" +
                   ...
                   "<P align='left'>Please <A href='http://ploutosstaffing.co.nr/Ploutos/ploutos/Activation.aspx?id=" + txtEmail.Text + "&id1=" + password1 + "'>CLICK HERE</A> to activate your account </P>" +
                   "<P align='left'>or</P>" +
                   "<P align='left'>copy and paste the below link to your web browser to activate your account </P> " +
                   "<P align='left'><A href='#'>http://ploutosstaffing.co.nr/Ploutos/Activation.aspx?id=" + txtEmail.Text + "&id1=" + password1 + "</A></P>" +
        ...
        mailMessage.Subject = "Mail from Ploutous Regarding Registration ";
